...
class CityConnectorTest {
	...
	void testCityConnector() {		     
        Assertions.assertTrue(cityConnector.isCitiesConnected("Boston", "Newark", simpleSearch));		
        Assertions.assertTrue(cityConnector.isCitiesConnected("Boston", "Philadelphia", simpleSearch));		
        Assertions.assertFalse(cityConnector.isCitiesConnected("Philadelphia", "Albany", simpleSearch));		
        Assertions.assertTrue(cityConnector.isCitiesConnected("Fort Worth", "Dallas", simpleSearch));		
        Assertions.assertTrue(cityConnector.isCitiesConnected("Fort Worth", "Austin", simpleSearch));		
        Assertions.assertTrue(cityConnector.isCitiesConnected("Fort Worth", "San Antonio", simpleSearch));		
        Assertions.assertTrue(cityConnector.isCitiesConnected("Fort Worth", "Houston", simpleSearch));		
        Assertions.assertFalse(cityConnector.isCitiesConnected("Fort Worth", "Boston", simpleSearch));		
        
        Assertions.assertFalse(cityConnector.isCitiesConnected("", "", simpleSearch));
        Assertions.assertFalse(cityConnector.isCitiesConnected("", "Boston", simpleSearch));
        Assertions.assertFalse(cityConnector.isCitiesConnected("Fort Worth", "", simpleSearch));
	}
